...
- Log which model was used for every call (transparency).
...
from causalguard.exceptions import ProviderError

logger = logging.getLogger("causalguard.llm")

# Suppress LiteLLM's own verbose startup logging
...
class LLMAdapter:
    ...
    def _build_messages(
        ...
        """Build the LiteLLM messages list from a prompt and optional system message."""
